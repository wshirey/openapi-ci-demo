...
[![Build Status](https://travis-ci.org/wshirey/openapi-ci-demo.svg?branch=master)](https://travis-ci.org/wshirey/openapi-ci-demo)
...
6. If you did everything correct, https://wshirey.github.io/openapi-ci-demo/ will lead to your new docs
...
- Documentation(ReDoc): https://wshirey.github.io/openapi-ci-demo/
- SwaggerUI: https://wshirey.github.io/openapi-ci-demo/swagger-ui/
- Look full spec:
    + JSON https://wshirey.github.io/openapi-ci-demo/swagger.json
    + YAML https://wshirey.github.io/openapi-ci-demo/swagger.yaml
- Preview spec version for branch `[branch]`: https://wshirey.github.io/openapi-ci-demo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://wshirey.github.io/openapi-ci-demo/ with url from the message: `Server started <url>`
